...
export default function Hero({
  ...
  return (
    <section className={`relative text-white ${minHeightClass}`}>
      ...
      {/* Center everything */}
      <div className="container-x flex items-center justify-center py-12 md:py-20 relative z-10">
        {/* Glass panel */}
        <div
          className={[
            "w-11/12 max-w-5xl",
            "rounded-[28px] md:rounded-4xl",
            "px-6 md:px-10 py-8 md:py-10",
            "backdrop-blur-sm",
            "bg-[var(--ink-900)]/70", // ✅ tailwind var + opacity
        ...
        >
          ...
          <div className="mt-6 flex justify-center">
            <button
              ...
              className="rounded-[var(--r-sm)] bg-[var(--green-500)] px-5 py-3 text-[var(--bg-950)] font-medium"
            >
              Get Started
            </button>
          </div>
